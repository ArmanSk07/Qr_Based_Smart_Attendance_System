...
_raw_cors = get_env('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,http://127.0.0.1:5173,https://qrbasedattendancefrontendui.vercel.app,https://qrbasedattendancefrontendui-git-main-arman-sk-s-projects.vercel.app')
